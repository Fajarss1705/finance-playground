...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Persetujuan Narasi', href: '#' },
];

const steps = [
    { code: 'PRBL01', label: 'Laporan', status: 'completed' as const },
    { code: 'PRBL02A', label: 'Narasi', status: 'active' as const },
...
export default function AdminPrbl02a() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="PRBL02A — Persetujuan Narasi" />
            <div className="space-y-6 p-6">
                <div className="flex items-start justify-between">
                    <Heading title="Persetujuan Narasi" description="Review laporan kegiatan dan realisasi bulan Maret 2027" />
                ...
                <StepProgress steps={steps} currentStep="PRBL02A" />
                ...
                <div className="flex justify-end gap-3">
                    ...
                    <ActionConfirmDialog
                        ...
                        title="Setujui Laporan Narasi?"
                        description="Narasi laporan akan disetujui dan dilanjutkan ke persetujuan anggaran (PRBL02B)."
