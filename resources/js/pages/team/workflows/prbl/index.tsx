...
const teamWorkflows = prblWorkflowList.filter((w) => w.team === 'Divisi Pendidikan');

export default function TeamPrblIndex() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Laporan Bulanan" />
            <div className="space-y-6 p-6">
                <Heading title="Laporan Bulanan" description="Daftar pelaporan dan realisasi anggaran tim" />
                                    ...
                                    <tr key={wf.id} className="border-b last:border-0 hover:bg-muted/30">
                                        ...
                                        <td className="px-4 py-3">
                                            <Button variant="outline" size="sm" asChild>
                                                <Link href={`/team/workflows/prbl/${wf.uuid}`}>Lihat</Link>
                                            </Button>
                                        </td>
                                    </tr>
                                ))
