...
class PkWorkflowController extends Controller
{
    ...
    public function pk05Create(Request $request, PkWorkflow $pkWorkflow): RedirectResponse
    {
        ...
        $pk05 = \App\Models\Pk\Pk05Data::create([
            'pk_workflow_id' => $pkWorkflow->id,
    ...
    public function pk05Show(PkWorkflow $pkWorkflow, \App\Models\Pk\Pk05Data $pk05Data): Response
    {
        $this->ensureWorkspaceOwnership($pkWorkflow);
    ...
    public function pk05Draft(\App\Http\Requests\Workflows\Pk05DraftRequest $request, PkWorkflow $pkWorkflow, \App\Models\Pk\Pk05Data $pk05Data): RedirectResponse
    {
        $this->ensureWorkspaceOwnership($pkWorkflow);
    ...
    public function pk05Submit(\App\Http\Requests\Workflows\Pk05SubmitRequest $request, PkWorkflow $pkWorkflow, \App\Models\Pk\Pk05Data $pk05Data): RedirectResponse
    {
        $this->ensureWorkspaceOwnership($pkWorkflow);
