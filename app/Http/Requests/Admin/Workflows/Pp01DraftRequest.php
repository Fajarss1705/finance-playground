...
class Pp01DraftRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kode_bidang_pelayanan.*.kode' => ['nullable', 'string', 'max:10'],
            'kode_bidang_pelayanan.*.nama' => ['nullable', 'string', 'max:255'],
            'kode_bidang_pelayanan.*.catatan' => ['nullable', 'string'],
            'kode_sub_bidang_pelayanan' => ['nullable', 'array'],
            'kode_sub_bidang_pelayanan.*.kode' => ['nullable', 'string', 'max:10'],
            'kode_sub_bidang_pelayanan.*.nama' => ['nullable', 'string', 'max:255'],
            'kode_sub_bidang_pelayanan.*.catatan' => ['nullable', 'string'],
            'kode_kategori_pelayanan' => ['nullable', 'array'],
            'kode_kategori_pelayanan.*.kode' => ['nullable', 'string', 'max:10'],
            'kode_kategori_pelayanan.*.nama' => ['nullable', 'string', 'max:255'],
            'kode_kategori_pelayanan.*.catatan' => ['nullable', 'string'],
            'kode_jenis_program' => ['nullable', 'array'],
            'kode_jenis_program.*.kode' => ['nullable', 'string', 'max:10'],
            'kode_jenis_program.*.nama' => ['nullable', 'string', 'max:255'],
