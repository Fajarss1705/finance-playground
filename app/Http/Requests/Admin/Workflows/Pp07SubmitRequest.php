...
class Pp07SubmitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'draft_data.rekening_organisasi' => ['nullable', 'array'],
            'draft_data.rekening_organisasi.*.nama_bank' => ['required_with:draft_data.rekening_organisasi', 'string', 'max:255'],
            'draft_data.rekening_organisasi.*.nama_rekening' => ['required_with:draft_data.rekening_organisasi', 'string', 'max:255'],
            'draft_data.rekening_organisasi.*.nomor_rekening' => ['required_with:draft_data.rekening_organisasi', 'string', 'max:50'],
