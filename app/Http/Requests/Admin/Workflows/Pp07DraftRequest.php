...
class Pp07DraftRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'draft_data.rekening_organisasi.*.nama_bank' => ['nullable', 'string', 'max:255'],
            'draft_data.rekening_organisasi.*.nama_rekening' => ['nullable', 'string', 'max:255'],
            'draft_data.rekening_organisasi.*.nomor_rekening' => ['nullable', 'string', 'max:50'],
